...
function List(){
	var frm=document.frm;
	    frm.action="/company.do?cmd=company_list";
		frm.method="post";
		frm.target="_self";
		frm.submit();
}
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td class="MenuTopText">회사코드 현황 &gt;&gt; TMLL</td>
                      </tr>
                  </table></td>
                </tr>
                 <tr>
                ...
                <tr>
                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="TableBg">회사ID</td>
					  <td class="TableBg">회사명</td>
...
//                        	}
					...
					<tr>
						<td colspan="9">검색된 페이지가 없습니다 "</td>
           				...
           				%>              
                          <tr>                       
	    		    		<td class="TableBgText"><%=goods_list_Tray.get("company_id",i) %></td>	    
	    		    		<td class="TableBgText"><%=goods_list_Tray.get("company_name",i) %></td>
					   		<td class="TableBgText"><%=goods_list_Tray.get("timeg",i) %></td>
