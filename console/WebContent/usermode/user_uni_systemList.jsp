...
function ok(process){
document.location.href="/usermode/process.jsp?process="+process;
          ...
          <td width="724" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="97" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td align="right" class="T11PgaeNum"><img style="margin-right:10px"src="<%=DIR_IMG%>icon02.gif" align="middle">총 <strong>1</strong> 페이지 <B><FONT COLOR="ed7338">1/1</FONT></b></td>
                </tr>
              </table></td>
            </tr>
            <tr>
                      ...
                      <td valign="top"><div style="height:312; overflow-y:scroll;">
						...
						<col width="*">
                          ...
                          <tr>
                            ...
                            <img src="<%=DIR_IMG%>btn_s_contact.gif" style="margin-left:13px"align="middle" onclick="ok('<%=mRemotePath%>')">
                            ...
                            <td class="TableBgText"><img src="<%=DIR_IMG%>unix_m.gif" style="margin-left:13px"align="middle"></td>
                          </tr>
