var fixedX = 130; // 레이어 X축 위치 (-1 : 버튼에 바로 아래에 표시)
var fixedY = 200; // 레이어 Y축 위치 (-1 : 버튼에 바로 아래에 표시)
...
var imgDir = '../img/'; // 이미지 디렉토리 - ./ : 현재 디렉토리
...
var scrollLeftMessage = "이전 달로 이동" // 이전 달(month)로 이동하는 버튼에 마우스 올리면 상태바에 나타는 메세지
// 원문 : Click to scroll to previous month. Hold mouse button to scroll automatically.
var scrollRightMessage = "다음 달로 이동" // 다음 달(month)로 이동하는 버튼에 마우스 올리면 상태바에 나타는 메세지
// 원문 : Click to scroll to next month. Hold mouse button to scroll automatically.
var selectMonthMessage = "달을 선택합니다." // 달(month)을 선택하는 부분에 마우스 올리면 상태바에 나타나는 메세지
// 원문 : Click to select a month.
var selectYearMessage = "년을 선택합니다." // 년(year)을 선택하는 부분에 마우스 올리면 상태바에 나타나는 메세지
// 원문 : Click to select a year.
var selectDateMessage = "날자를 선택합니다. : [날자]" // 날자에 마우스 올렸을시 상대바에 나타나는 메세지 / [data] : 날자를 표시
...
if(dom) {
    ...
    document.write ("<div onclick='bShow=true' id='calendar'    style='z-index:+999;position:absolute;visibility:hidden;'><table    width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr bgcolor='#0000aa'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"closeCal.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Close the Calendar'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>");
