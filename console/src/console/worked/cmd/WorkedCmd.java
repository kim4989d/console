...
import console.worked.dao.WorkedDao;


public class WorkedCmd extends BaseCommand{
	public String str="testabc";
	public String checkbox="";
	public String checkbox2="";
	
	public WorkedCmd() {
		setNextPage("/worked/worked_list.jsp?");
	}
