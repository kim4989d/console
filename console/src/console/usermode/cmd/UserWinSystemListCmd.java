...
import console.usermode.dao.UserWinSystemListDao;


public class UserWinSystemListCmd extends BaseCommand{
	public String str="testabc";
	public String checkbox="";
	public String checkbox2="";
	
	public UserWinSystemListCmd() {
		setNextPage("/usermode/user_win_systemList.jsp?");
	}
	...
	protected void doExecute(Tray reqTray, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			UserWinSystemListDao dao = new UserWinSystemListDao();
