...
public String nextpage="";
	...
	public ResultSetTray CheckLogin(Connection conn,Tray reqTray){
		...
		query.append("SELECT                                                      \n");      
		query.append("	USER_ID,PASSWORD,NAME,KIND,ADMIT_FLAG,IFNULL(TYPE,'C')    \n");
		query.append("	AS TYPE,IFNULL(CERT_DATE,NULL) AS CERT_DATE,LAST_LOGIN_DT \n");
		query.append("from TBL_USER                                               \n");      
		query.append("where USER_ID =:user_id and  PASSWORD=:passwd               \n");      
