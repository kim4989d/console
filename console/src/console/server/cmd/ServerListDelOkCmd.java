...
//		String write="";
		...
		try {
			...
			rsTray_H=dao.EquipmentListDelInsert(getConnection(),reqTray);  		// 삭제 전  HISTORY 에 저장할 파일을 불러움
			rsTray2=dao.EquipmentListDel(getConnection(),reqTray, rsTray_H);    // 삭제 전 HISTORY 에 저장
			rsTray3=dao.EquipmentListDelOk(getConnection(),reqTray);		    // 삭제  TBL_SYSTEM
			rsTray4=dao.EquipmentListDelOk2(getConnection(),reqTray);           // 삭제  TBL_USER_SYSTEM
