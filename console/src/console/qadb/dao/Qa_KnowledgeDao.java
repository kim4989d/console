...
//	
	...
	public String getPaging(int totalnum,String page,String paging) {
		...
		for(int i=1;i<=totalPage;i++){
			if(i !=pagin)
				sb.append("&nbsp;&nbsp;<font color=#A8A8A8><A href =/QADBServlet?cmd=qa_knowledge&paging=" +i+"&page="+page+"> " + i + " </A>&nbsp;");
		    else
				 sb.append(" " + i + " ");
	...
	public ResultSetTray Qa_KnowledgeList(Connection conn,Tray reqTray){
