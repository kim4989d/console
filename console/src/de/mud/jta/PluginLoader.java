 ...
 *
 * @version $Id: PluginLoader.java,v 1.1 2009/02/09 06:57:28 kim4989 Exp $
 * @author Matthias L. Jugel, Marcus Mei�ner
 */
public class PluginLoader implements PluginBus {
  /** holds the current version id */
  public final static String ID = "$Id: PluginLoader.java,v 1.1 2009/02/09 06:57:28 kim4989 Exp $";
