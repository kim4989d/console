 ...
 *
 * @version $Id: TelnetProtocolHandler.java,v 1.1 2009/02/09 06:57:34 kim4989 Exp $
 * @author  Matthias L. Jugel, Marcus Meissner
 */
public abstract class TelnetProtocolHandler {
  /** contains the current revision id */
  public final static String ID = "$Id: TelnetProtocolHandler.java,v 1.1 2009/02/09 06:57:34 kim4989 Exp $";
